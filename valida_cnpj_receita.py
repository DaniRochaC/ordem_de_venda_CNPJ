...
for pacote in ["pandas", "streamlit", "requests", "pillow", "openpyxl"]:
...
# ======== Função para converter imagem em base64 (para link clicável) ========
...
st.markdown(
    """
    <h2 style='text-align: center;'>🧾 Validação de CNPJs com a Receita Federal</h2>
            ...
            try:
                ...
                st.markdown(
                    ...
                    <a href="https://solucoes.receita.fazenda.gov.br/servicos/cnpjreva/Cnpjreva_Solicitacao.asp" target="_blank">
                        <img src="data:image/png;base64,{img_base64}" width="250" style="border-radius: 12px;">
                    </a>
                    """,
                    unsafe_allow_html=True
                )
